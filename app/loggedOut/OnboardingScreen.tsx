        ...
        <View style={{ flex: 1, backgroundColor: theme.background }}>
            <ViewPager style={{ flex: 1 }} ref={pagerRef}>
                <View key="1">
                    ...
                    >
                        <View style={{ flex: 1, margin: 50, ...Styles.centeringContainer }}>
                            <MaterialIcons name="science" size={size} color={theme.accent} />
                ...
                <View key="2">
                    ...
                    >
                        <View style={{ flex: 1, margin: 50, ...Styles.centeringContainer }}>
                            <Ionicons name="game-controller" size={size} color={theme.accent} />
                ...
                <View key="3">
                    ...
                    >
                        <View style={{ flex: 1, margin: 50, ...Styles.centeringContainer }}>
                            <MaterialCommunityIcons name="fire" size={size} color={theme.accent} />
                ...
                <View key="4">
                    ...
                    >
                        <View style={{ flex: 1, margin: 50, ...Styles.centeringContainer }}>
                            <FontAwesome5 name="user-friends" size={size} color={theme.accent} />
