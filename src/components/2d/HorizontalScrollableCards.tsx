...
export interface HorizontalScrollableCardsRef<T> {
 ...
 */
const HorizontalScrollableCards = <T extends BaseCardAttributes>(props: HorizontalScrollableCardsProps<T>, ref: React.Ref<HorizontalScrollableCardsRef<T>> | undefined) => {
...
export default forwardRef(HorizontalScrollableCards) as <T extends BaseCardAttributes>(props: HorizontalScrollableCardsProps<T> & { ref?: React.Ref<HorizontalScrollableCardsRef<T>> }) => JSX.Element;
